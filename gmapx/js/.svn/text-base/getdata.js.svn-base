...
function filter_data() {
	...
	var domainUrl = 'http://www.divedns.com';
    ...
    $.ajax({
        ...
        success: function (data) {
            $.each(data, function (i) {
                ...
                var prophtml = '<div class="hotel" id="b_overlay"><h3>' +  title + '</h3><p><img alt="" src="images/t.jpg">' + title +  lat+ lng+ '</p><p>&nbsp;</p></div>'
