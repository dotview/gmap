...
<div class="container" style="margin:0 auto;width:1000px;"> 
	...
	<span style="display:none;" id="progress">progress...</span> 
	</div> 
 
<div class="hinweis-bottom-rounded hinweistip-rounded mapTooltip" id="filterbox">
		<div style="overflow: visible; height: auto;" class="hinweistip-outer">
				<div class="fTop"><div class="hinweistip-title">Change filtering</div> 
				<div class="hinweistip-close"><a class="close">X</a></div></div>
				<div class="hininnerInput" >
					<form name="form">
					<?php if(isset($lst)) {?>
						<p>Select Calander:</p>
						<p>
						<?php foreach($lst["items"] as   $index=>$row){?>
						  <input type="radio" name="calendar[]"  class="calendar"	value=<?php echo $row["id"]?> />

						  <label for="calendar[]"><?php echo $row["summary"]?></label>

						<?php } ?>
						</p>
					<?php } ?>
					<p>Search:</p>
					<p><input type="text" id="keyword" name="keyword" />
					</p>
					<p>Date From:</p>
					<p><input type="text" id="dateStart" name="dateStart" />
					</p>
					<p>Date To:</p>
					<p><input type="text" id="dateEnd" name="dateEnd" />
					</p>
					<p>Timezone:</p>
					<p>
					<select id="timezone" name="timezone" class="jqTransformHidden" style="">
					...
					<p><input type="button" id="btnSubmit" value="Filter" />
					</p>
					</form>
				</div>	
		</div>
</div>	
	<div id="map_canvas" style="float:left;width:700px;height:700px"></div> 
	<div style="float:right;width:300px;height:700px;overflow:auto"> 
	<input type="button" id="btnFilter" value="Change Filtering" />
