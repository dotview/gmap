...
$business_street_address = $_GET['a'];
$business_city = $_GET['c'];
$business_lat = $_GET['lat'];
$business_lng = $_GET['lng'];


//$address= 'address='.$the_field('business_street_address').',+Israel&sensor=false'";
//$geocode=file_get_contents(str_replace(' ',',',('http://maps.google.com/maps/api/geocode/json?address='.$business_street_address.','.$business_city.',+Israel&sensor=false')));
...
<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false"></script>
		<script type="text/javascript">
			function initialize() {
				var latlng = new google.maps.LatLng(<? echo $business_lat.','.$business_lng; ?>);
				...
				var infowindow = new google.maps.InfoWindow({
					content: contentString
								...
								var companyImage = new google.maps.MarkerImage('http://street-view.co.il/wp-content/themes/yoo_shelf_wp/layouts/googlemaps/images/ricon.png',
  ...
  new google.maps.Point(15,35)
				...
				var companyPos = new google.maps.LatLng(<? echo $business_lat.','.$business_lng; ?>);
