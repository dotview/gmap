...
function googleMap(color,markerURL) {
	...
	self.markerImages = [self.colorPath + "images/schools.png",
						 self.colorPath + "images/shops.png",
						 self.colorPath + "images/restaurants.png",
						 self.colorPath + "images/trails.png",
						 self.colorPath + "images/transportation.png",
						 self.colorPath + "images/amenities.png"];
