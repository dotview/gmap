...
Drupal.gmap.addHandler('gmap', function (elem) {
  ...
  obj.bind('clickmarker', function (marker) {   // 'clickmarker' chaged to 'mouseovermarker' by striketeam
  ...
  //new For over
    obj.bind('mouseovermarker', function (marker) {   // 'clickmarker' chaged to 'mouseovermarker' by striketeam
    // Local/stored content
    if (marker.text) {
      //alert(marker.text);
        marker.marker.openInfoWindowHtml(marker.text);
  ...
  //obj.bind('mouseoutmarker', function (marker) {
    //marker.marker.closeInfoWindowHtml(marker.text);
