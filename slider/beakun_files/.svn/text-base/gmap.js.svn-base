...
var center = new GLatLng(42.102, -72.585)
map.setCenter(center, 15);

/// ////////////////////Start of colorSwitch code
/// Feel free to use
///Please include the following line 
/// Original script by Esa 2007
function createColorSwitchMarker(point,html){
var marker1 = new GMarker(point,{draggable:true});
map.addOverlay(marker1);
marker1.enableDragging();

var marker2 = new GMarker(marker1.getPoint(),{clickable:false, icon:yellowIcon});
map.addOverlay(marker2); // visited
marker2.hide();

var marker3 = new GMarker(marker1.getPoint(),{clickable:false, icon:turqIcon});
...
var point = new GLatLng(42.1, -72.5831 );
var html = "<img src=";
html += markerImage[0];
html += "> link <br/>"
html += "<img src=";
...
point = new GLatLng(42.105, -72.585 );
html = "Wow!";
createColorSwitchMarker(point,html);

point = new GLatLng(42.103, -72.584 );
html = "Cool!";
createColorSwitchMarker(point,html);

point = new GLatLng(42.103, -72.59 );
html = "<img src='http://images.google.fi/images?q=tbn:l06yfAuLHmIz2M:http://als.lib.wi.us/Bart%2520Simpson.jpg' height='121px'>";
createColorSwitchMarker(point,html);


//  Keeping the original center
